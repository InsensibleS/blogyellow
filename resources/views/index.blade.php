            ...
            <div class="col-md-6">
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                  ...
                  <h3>API 1</h3>
                  <p>Test API 1</p>
                  <p><a href="#" class="btn btn-primary">Подключить</a> <span class="enrolled-count">2,928 пользователей подключило</span></p>
                </div>
              </div>
              ...
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                  ...
                  <h3>API 2</h3>
                  <p>Test API 2</p>
                  <p><a href="#" class="btn btn-primary">Подключить</a> <span class="enrolled-count">7,202 пользователей подключило</span></p>
                </div>
              </div>
